...
"""
For embedding-based models, we
compared with TransE (Bordes et al., 2013),
Dist-Mult (Yang et al., 2015), 
ConvE (Dettmers et al.,
2018) 
and TuckER (Balazevic et al., 2019
类建立、初始化、get_xxx_nn_state_dict(state_dict)
def get_xxx_kg_state_dict(state_dict):
def get_xxx_kg_state_dict_from_vec(path):
问题：
forward、forward_fact函数做什么用
"""
