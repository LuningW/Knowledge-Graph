"""
 ...
 Policy gradient with reward shaping.有奖励形成的政策梯度
"""
...
"""
这个文件和之前的pg 的不同
有几个文件里也出现了奖励函数，这些有什么不同
format_batch(self, batch_data, num_labels=-1, num_tiles=1, inference=False):
convert batched tuples to the tensors accepted by the NN  将成批的图元转换为NN所接受的标量
